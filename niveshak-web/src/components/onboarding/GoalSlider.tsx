...
export function GoalSlider({ sliderConfig, value, onChange, minLabel, maxLabel }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-input border border-line rounded-lg p-4 flex flex-col items-center gap-1">
        {isEditing ? (
          ...
          >
            ...
            <svg
              ...
              className="text-hint group-hover:text-accent transition-colors"
            >
